//Defining the child class StandardVisitor 
public class StandardVisitor extends ArtGalleryVisitor{
    //Declaring the attributes of this class which has private access modifier 
    ...
    //implementing method calculateRewardPoint() from the parents class which will calculate the reward points gained by the visitor
    @Override
